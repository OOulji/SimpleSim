...
class Integrator(ABC):
    ...
    @abstractclassmethod
    def integrate(t, y0:np.array,fun,*args):
        pass

class EulerIntegrator(Integrator):

    def integrate(t, y0:np.array ,fun):
...
class Euler2DIntegrator(Integrator):
